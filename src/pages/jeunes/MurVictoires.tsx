    ...
    return (
        <div className="p-8 text-white max-w-4xl mx-auto">
            ...
            <form onSubmit={handleSubmit} className="bg-slate-900 p-6 rounded-xl mb-12">
                ...
                <textarea placeholder="Description" value={description} onChange={e => setDescription(e.target.value)} className="w-full mb-4 p-2 bg-slate-800 rounded" required />
                ...
                <button type="submit" className="bg-indigo-600 px-6 py-2 rounded">Partager ma victoire</button>
            </form>
